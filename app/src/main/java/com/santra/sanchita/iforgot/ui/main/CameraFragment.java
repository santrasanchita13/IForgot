...
import com.santra.sanchita.iforgot.ui.base.BaseFragment;
import com.santra.sanchita.iforgot.ui.preview.PreviewActivity;
import com.santra.sanchita.iforgot.utils.AppLogger;
import com.santra.sanchita.iforgot.utils.AutoFitTextureView;
...
public class CameraFragment extends BaseFragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                switch (displayRotation) {
                    ...
                    case Surface.ROTATION_270:
                        ...
                        break;
                    default:
                        AppLogger.d("CameraFragment", "Display rotation is invalid: " + displayRotation);
                }
            ...
            showMessage("Sorry!!!, camera 2 is not supported on your device");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == Constants.REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                // close the app
                showMessage("Sorry!!!, you can't use this app without granting permission");
                Activity activity = getActivity();
                if (null != activity) {
                    activity.finish();
                }
